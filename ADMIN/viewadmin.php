                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-5">
                                         <div class="form-group">
                                             ...
                                             <a href="../functions.php?approve=<?php echo $idtab; ?>" class="approve_btn">Approve</a>
                                             <a href="../functions.php?reject=<?php echo $idtab; ?>" class="reject_btn">Reject</a>
                                         </div>
                                     </div>
                                    </div>
