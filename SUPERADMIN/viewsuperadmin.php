...
<div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">                      
                        <li>
                            <a href="viewsuperadmin.php?logout='1'">
                                <p>Log out</p>
                            </a>
                        </li>
                    ...
                    <div class="col-md-4 col-lg-12">
                        <div class="card">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-5">
                                         <div class="form-group">
                                             ...
                                             <a href="../functions.php?superapprove=<?php echo $idtab; ?>" class="approve_btn">Approve</a>
                                             <a href="../functions.php?supereject=<?php echo $idtab; ?>" class="reject_btn">Reject</a>
                                         </div>
                                     </div>
                                    </div>
							...
							<div class="row">
                                    ...
                                    <div class="clearfix"/>&nbsp;
									<input type="button" onclick="location.href='forms.php';" name="back" class="btn btn-info btn-fill pull-center" value="Back"/>
                                    <div class="clearfix" >
							</div>
        ...
        function appFunction(){
            ...
            $approve = "Approved";
		      ...
		      mysqli_query($db, "UPDATE forms SET status='$approve' WHERE id=$id");
                ...
                echo 'alert("Form has been approved!");';
    ...
    <script>
        function rejFunction(){
            ...
            echo '<script language="javascript">';
            echo 'alert("Form has been rejected!");';
            echo 'window.location.href = "viewadmin.php";';
            echo '</script>';
            ?>
        }
