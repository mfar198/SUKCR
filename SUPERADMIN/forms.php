...
<form method="post" action="forms.php" >
        ...
        <input type="submit" name="superesets" value="Reset" class="btn btn-info btn-fill"><br>
        </div>
                               <table>
	<thead>
		<tr>
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
            ...
            <td>
				<a href="../SUPERADMIN/viewsuperadmin.php?id=<?php echo $row['id']; ?>" class="view_btn">View</a>
			</td>
            <td>
				<a href="../functions.php?superapprove=<?php echo $row['id']; ?>" class="approve_btn">Approve</a>
			</td>
			<td>
				<a href="../functions.php?supereject=<?php echo $row['id']; ?>" class="reject_btn">Reject</a>
			</td>
		</tr>
	<?php } ?>
</table>
