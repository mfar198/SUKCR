...
<div class="wrapper">
    ...
    <div class="main-panel">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">                      
                        <li>
                            <a href="updateadmin.php?logout='1'">
                                <p>Log out</p>
                            </a>
                        </li>
        ...
        <div class="content">
	        ...
	        <?php endif ?>
                                <form id="updateuser" name="updateadmin" action="updateadmin.php" method="post" accept-charset='UTF-8'>
                                 ...
                                 <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="password_1" placeholder="Password" value="<?php echo $password_1; ?>" >
                                            </div>
                                        </div>                                    
                                    </div>
                                    ...
                                    <button type="submit" name="updateadmin_btn" class="btn btn-info btn-fill pull-left">Update</button>
                                    <div class="clearfix">&nbsp;
